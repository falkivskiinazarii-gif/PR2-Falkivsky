...
# --- 1. Виносимо логіку в окрему чисту функцію (її ми будемо тестувати) ---
def calculate_exchange(amount, rate):
    """Функція повертає результат множення суми на курс."""
    return amount * rate

# --- 2. Функція інтерфейсу ---
def convert_currency():
    try:
        ...
        try:
            ...
            # Викликаємо нашу логічну функцію
...
# --- 3. Запуск інтерфейсу тільки якщо файл запущено напряму ---
